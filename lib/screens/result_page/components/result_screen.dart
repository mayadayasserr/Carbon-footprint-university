              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("5000kg"/*+widget.answersData["carbon emissions"]+" Kg"*/, //edittttttttttttttttt
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 24,
                          fontFamily: "Poppins",
                  ...
                  SizedBox(height: SizeConfig.screenHeight*0.01,),
                  Text("electricity"+largestValue, //edittttttttttttttt
                    style: TextStyle(
                      ...
                      children: [
                        Row(
                            children: [
                              ...
                              SizedBox(
                                width: 300,
                                child: Text("adviceeeeeeeeeee"+advice1,
                                    maxLines: 2,
                                    style: TextStyle(
                                      color: Color(0xFF474747),
                                      fontSize: 16,
                      ...
                      children: [
                        Row(
                            children: [
                              ...
                              SizedBox(
                                width: 300,
                                child: Text("adviceeeeeeeeeee"+advice2,
                                    maxLines: 2,
                                    style: TextStyle(
                                      color: Color(0xFF474747),
                                      fontSize: 16,
                      ...
                      children: [
                        Row(
                            children:[ Container(
                              ...
                              SizedBox(
                                width: 300,
                                child: Text("adviceeeeeeeeeee"+advice3,
                                    maxLines: 2,
                                    style: TextStyle(
                                      color: Color(0xFF474747),
                                      fontSize: 16,
